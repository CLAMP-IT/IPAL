...
require_once($CFG->dirroot . "/mod/ipal/quiz/editlib.php");
...
class quiz_grading_report extends quiz_default_report {
    ...
    function display($quiz, $cm, $course) {
        ...
        if (!has_capability('mod/ipal/quiz:grade', $this->context)) {
        ...
        $this->users = get_users_by_capability($this->context, array('mod/ipal/quiz:reviewmyattempts', 'mod/ipal/quiz:attempt'),'','','','',$currentgroup,'',false);
        ...
        $this->viewurl = new moodle_url('/mod/ipal/quiz/report.php', $viewoptions);
