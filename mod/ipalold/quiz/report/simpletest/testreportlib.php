<?php
/**
 * Unit tests for (some of) mod/ipal/quiz/report/reportlib.php
 *
...
require_once($CFG->dirroot . '/mod/ipal/quiz/report/reportlib.php'); // Include the code to test

/** This class contains the test cases for the functions in reportlib.php. */
class question_reportlib_test extends UnitTestCase {
    public static $includecoverage = array('mod/ipal/quiz/report/reportlib.php');
