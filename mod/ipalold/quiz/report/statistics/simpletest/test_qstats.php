<?php
/**
 * Unit tests for (some of) mod/ipal/quiz/report/statistics/qstats.php.
 *
...
require_once($CFG->dirroot.'/mod/ipal/quiz/report/reportlib.php');
...
class quiz_report_qstats_test extends UnitTestCase {
    ...
    function test_qstats() {
        ...
        $states = $this->get_records_from_csv($CFG->dirroot.'/mod/ipal/quiz/report/statistics/simpletest/mdl_question_states.csv');
        //data is taken from questions mostly generated by contrib/tools/generators/generator.php
        $questions = $this->get_records_from_csv($CFG->dirroot.'/mod/ipal/quiz/report/statistics/simpletest/mdl_question.csv');
