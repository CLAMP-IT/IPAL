...
include $CFG->dirroot."/mod/ipal/quiz/report/reportlib.php";
...
if ($groupid && $groupmode = groups_get_activity_groupmode($cm)) {   // Groups are being used
    ...
    if (array_key_exists($groupid, $groups)){
        ...
        if (!$groupusers = get_users_by_capability($modcontext, array('mod/ipal/quiz:reviewmyattempts', 'mod/ipal/quiz:attempt'),'','','','',$group->id,'',false)){
...
require_capability('mod/ipal/quiz:viewreports', $modcontext);
