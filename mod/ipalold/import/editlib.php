 ...
 */
echo "\n<br />debug12 in editlib";
require_once('./questionlib.php');echo "\n<br />debug13 in editlib and this is a local file now";
...
echo "\n<br />debug604 in editlib inside function question_edit_setup";
    ...
    }echo "\n<br />debug612 in editlib inside function question_edit_lib";
    if ($cmid){
...
echo "\n<br />debug635 in editlib inside function question_edit_lib";
    if ($thiscontext){
...
echo "\n<br />debug645 in editlib inside function question_edit_lib";
...
echo "\n<br />debug666 in editlib inside function question_edit_lib";
    ...
    $sortoptions = array('alpha' => 'name, qtype ASC',
                          ...
                          'age' => 'id ASC');
echo "\n<br />debug677 in editlib inside function question_edit_lib";
...
echo "\n<br />debug686 in editlib inside function question_edit_lib";
    $defaultcategory = question_make_default_categories($contexts->all());
echo "\n<br />debug688 in editlib inside function question_edit_lib";
    $contextlistarr = array();
    foreach ($contexts->having_one_edit_tab_cap($edittab) as $context){
        $contextlistarr[] = "'$context->id'";
    }echo "\n<br />debug692 in editlib inside function question_edit_lib";
...
echo "\n<br />debug703 in editlib inside function question_edit_lib";
...
echo "\n<br />debug733 in editlib inside function question_edit_lib";
