...
if($debug){
  ...
  function random_string1 ($length=15) {
	...
	for($k=1;$k<3;$k++){
		...
		if($questionInsert->qtype == 'truefalse'){
			$qtypeInsert ->question = $lastinsertid;echo "\n<br />debug371 and lastinsertid is $lastinsertid and this is ".$qtypeInsert->question;
			echo "\n<br />debug372 the array for question_truefalse is ";
			print_r($qtypeInsert);
		}
	}
