 ...
 * @package quiz
 * Polling modified by W. F. Junkin for use with in-class polling
 *//** */

require_once('../../config.php');
require_once($CFG->dirroot . '/mod/ipal/editlib.php');//Ppolling modified
require_once($CFG->dirroot . '/mod/ipal/addrandomform.php');//Polling Modified
...
add_to_log($cm->course, 'ipal', 'editquestions',
            "view.php?id=$cm->id", "$quiz->id", $cm->id);//polling modified 
...
if (!$quiz_reordertool) {
    $randomform = new quiz_add_random_form(new moodle_url('/mod/ipal/addrandom.php'), $contexts);//Polling modified
