...
require_once($CFG->dirroot . '/mod/ipal/ipaleditlib.php');//Ipal modification
//require_once($CFG->dirroot . '/mod/ipal/addrandomform.php');//Ipal modification
require_once($CFG->dirroot . '/question/category_class.php');
require_once($CFG->dirroot . '/question/engine/lib.php');//Modified for ipal so that the class question_display_options is defined
...
list($thispageurl, $contexts, $cmid, $cm, $quiz, $pagevars) =
        question_edit_setup('editq', '/mod/ipal/ipaledit.php', true);//Modified for ipal
...
$pagetitle = get_string('editingquiz', 'quiz');//Need to Modified for ipal
if ($quiz_reordertool) {
...
$PAGE->requires->skip_link_to('quizcontentsblock',
        get_string('skipto', 'access', get_string('questionsinthisquiz', 'quiz')));$pagetitle = "Edit ipal settings";//Modified for ipal 
...
if ($quiz_reordertool) {
    ...
    $currenttab = 'edit';
}$durrenttab = 'edit';//Modified for ipal
$tabs = array(array(
    new tabobject('edit', new moodle_url($thispageurl,
            array('reordertool' => 0)), get_string('editingquiz', 'quiz')),
    //new tabobject('reorder', new moodle_url($thispageurl,//Commented out Modified for ipal
      //      array('reordertool' => 1)), get_string('orderingquiz', 'quiz')),//Commented out Modified for ipal
));
...
echo '<div class="bd">';echo "\n<br />debug454 and the pagevars array is ".print_r($pagevars);
