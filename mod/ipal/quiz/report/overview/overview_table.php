...
class quiz_report_overview_table extends table_sql {
     ...
     * mod/ipal/quiz/report/overview/report.php to see what fields are present,
        ...
        if (preg_match('/^qsgrade([0-9]+)$/', $colname, $matches)){
            ...
            if ($stateforqinattempt && question_state_is_graded($stateforqinattempt)) {
                ...
                if (!$this->is_downloading()) {
                    ...
                    $link = new moodle_url("/mod/ipal/quiz/reviewquestion.php?attempt=$attempt->attempt&question=$question->id");
