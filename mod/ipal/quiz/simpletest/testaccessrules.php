<?php
/**
 * Unit tests for (some of) mod/ipal/quiz/accessrules.php.
 *
...
require_once($CFG->dirroot . '/mod/ipal/quiz/locallib.php');

class simple_rules_test extends UnitTestCase {
    public static $includecoverage = array('mod/ipal/quiz/locallib.php');
