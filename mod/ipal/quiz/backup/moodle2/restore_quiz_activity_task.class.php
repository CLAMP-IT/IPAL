...
require_once($CFG->dirroot . '/mod/ipal/quiz/backup/moodle2/restore_quiz_stepslib.php'); // Because it exists (must)
...
class restore_quiz_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('QUIZVIEWBYID', '/mod/ipal/quiz/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('QUIZVIEWBYQ', '/mod/ipal/quiz/view.php?q=$1', 'quiz');
        $rules[] = new restore_decode_rule('QUIZINDEX', '/mod/ipal/quiz/index.php?id=$1', 'course');
