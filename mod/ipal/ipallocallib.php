...
require_once($CFG->dirroot . '/mod/quiz/lib.php');//Commented out Modified for ipal
require_once($CFG->dirroot . '/mod/quiz/accessrules.php');//Commented out Modified for ipal
require_once($CFG->dirroot . '/mod/quiz/renderer.php');//Commented out Modified for ipal
require_once($CFG->dirroot . '/mod/quiz/attemptlib.php');//Commented out Modified for ipal
